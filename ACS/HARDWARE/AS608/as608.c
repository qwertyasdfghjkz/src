...
const char *EnsureMessage(u8 ensure) 
{
	...
	switch(ensure)
	{
		case  0x00:
			p="OK";break;		
		case  0x01:
			p="Data receiving error";break;
		case  0x02:
			p="No fingers";break;
		case  0x03:
			p="Failed to enter fingerprint";break;
		case  0x04:
			p="Image error 0x04";break;
		case  0x05:
			p="Image error 0x05";break;
		case  0x06:
			p="Image error 0x06";break;
		case  0x07:
			p="Image error 0x07";break;
		case  0x08:
		...
		case  0x0b:
			p="Address error 0x0b";
		case  0x10:
			p="Deletion failed";break;
		case  0x11:
			p="Emptying failed";break;	
		case  0x15:
			p="Cache error 0x15";break;
		case  0x18:
			p="Flash error";break;
		case  0x19:
			p="error 0x19";break;
		case  0x1a:
			p="Register error 0x1a";break;
		case  0x1b:
			p="Register error 0x1b";break;
		case  0x1c:
			p="Notepad error";break;
		case  0x1f:
			p="Fingerprint full database";break;
		case  0x20:
			p="Address error";break;
		default :
			p="Return error";break;
	}
 return p;	
}
